...
Анализ спецификации:
1. Раздел info: содержит метаданные API (название, описание, версия)
2. Раздел paths: описывает все эндпоинты, их параметры, тела запросов и ответов
3. Раздел components/schemas: содержит схемы данных (Book, BookUpdate, HTTPValidationError)
4. Для каждого эндпоинта указаны:
• HTTP метод
• Параметры (path, query, body)
...
## Задание 6: Добавление аутентификации
Добавьте простую аутентификацию с использованием API ключей.
